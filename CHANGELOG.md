...
## [Unreleased](https://github.com/cpjet64/WebAI-MCP/compare/v1.4.3-dev.5...HEAD)
...
- fix: update all browser-tools references to webai branding
- chore: bump dev version to 1.4.3-dev.4 and update changelog
- resolve: merge conflict in CHANGELOG.md
- fix: missed npm ci in test.yml lint job
- fix: properly address GitHub Actions issues
- chore: bump dev version to 1.4.3-dev.3 and update changelog
