...
## [Unreleased](https://github.com/cpjet64/WebAI-MCP/compare/v1.4.3-dev.9...HEAD)
...
- feat: enhance version check tools with comprehensive MCP capabilities
- chore: bump dev version to 1.4.3-dev.6 and update changelog
- merge: resolve conflicts and integrate remote changes
- docs: add comprehensive installation methods documentation
- chore: bump dev version to 1.4.3-dev.5 and update changelog
- Merge branch 'dev' of https://github.com/cpjet64/WebAI-MCP into dev
