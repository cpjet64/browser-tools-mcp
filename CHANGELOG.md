...
## [Unreleased](https://github.com/cpjet64/WebAI-MCP/compare/v1.5.0-dev.6...HEAD)

### Commits

- trigger: force GitHub Actions workflow to run [`NEW`](https://github.com/cpjet64/WebAI-MCP/commit/NEW)

## [1.5.1-dev.1] - 2025-05-27

### 🧪 **Development Release - Patch Version**

This is an automated development release with patch-level improvements and GitHub Actions testing.

#### **✨ Recent Changes**
- **GitHub Actions Testing**: Patch version bump to test automated workflow triggers
- **Security Documentation**: Comprehensive documentation to prevent GitGuardian false positives
- **Version Printing Enhancement**: Both WebAI Server and MCP Server display version information on startup
- **Multi-Client Connection Support**: Complete implementation of simultaneous MCP Inspector and Chrome Extension connections
- **MCP Stdio Communication Fix**: All 43 console statements replaced with MCP-safe logging system
- **Enhanced Connection Management**: Robust cleanup and graceful shutdown for multiple clients
- **Clean Protocol Communication**: stdout reserved for MCP JSON-RPC, stderr for logging

#### **🔒 Security Improvements**
- Added GitGuardian ignore comments for test tokens
- Comprehensive documentation explaining test data nature
- Clear separation between test data and real credentials
...
- WebAI Server: `Starting WebAI Server v1.5.1-dev.1...`
- MCP Server: `[MCP-ERROR] Starting WebAI MCP Server v1.5.1-dev.1...`

---

## [1.5.0-dev.6] - 2025-05-27
...
#### **✨ Recent Changes**
- **Security Documentation**: Added comprehensive documentation to test files to prevent GitGuardian false positives
- **Version Printing Enhancement**: Both WebAI Server and MCP Server now display version information on startup
- **Multi-Client Connection Support**: Complete implementation of simultaneous MCP Inspector and Chrome Extension connections
- **MCP Stdio Communication Fix**: All 43 console statements replaced with MCP-safe logging system
- **Enhanced Connection Management**: Robust cleanup and graceful shutdown for multiple clients
- **Clean Protocol Communication**: stdout reserved for MCP JSON-RPC, stderr for logging
...
#### **🔧 Version Display Examples**
- WebAI Server: `Starting WebAI Server v1.5.0-dev.6...`
- MCP Server: `[MCP-ERROR] Starting WebAI MCP Server v1.5.0-dev.6...`

---

## [1.5.0-dev.5] - 2025-05-27
...
#### **🔧 Version Display Examples**
- WebAI Server: `Starting WebAI Server v1.5.0-dev.5...`
- MCP Server: `[MCP-ERROR] Starting WebAI MCP Server v1.5.0-dev.5...`

---

## [1.5.0-dev.4] - 2025-05-27
...
- Fix MCP stdio communication and implement multi-client connection support
- chore: bump dev version to 1.5.0-dev.3 and update changelog
- Merge branch 'dev' of https://github.com/cpjet64/WebAI-MCP into dev
- Fix critical privacy filtering bugs and enhance security
- chore: bump dev version to 1.5.0-dev.2 and update changelog
- chore: bump version to 1.5.0 for minor release
- feat: organize all test files into dedicated tests directory
- chore: bump dev version to 1.4.3-dev.7 and update changelog
- Merge branch 'dev' of https://github.com/cpjet64/WebAI-MCP into dev
...
## [v1.4.3-dev.7](https://github.com/cpjet64/WebAI-MCP/compare/v1.4.3-dev.6...v1.4.3-dev.7) - 2025-05-26
